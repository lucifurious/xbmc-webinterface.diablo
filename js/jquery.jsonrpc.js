(function($) {
  $.extend({
    jsonRPC: {
      ...
      _doRequest: function(data, options) {
        ...
        $.ajax({
          ...
          error: function(xhr, status, errorThrown ) {
            _that._requestError.call(_that, xhr, status, errorThrown, options.error);
          },
          success: function(json,status,xhr) {
            _that._requestSuccess.call(_that, json, status, xhr, options.success, options.error);
          }
        });
      },
      ...
      _requestError: function(xhr, status, errorThrown, callback) {
        if (typeof(callback) !== 'undefined' && typeof(callback) === 'function') {
            callback(this._response(), xhr, status, errorThrown);
        }
      },
      ...
      _requestSuccess: function(json, status, xhr, success, error) {
        ...
        if(typeof(success) === 'function') {
          success(response,json, status, xhr);
        }
      },
